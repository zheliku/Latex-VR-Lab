...
\author{1 First Author\inst{1}\orcidID{0000-1111-2222-3333} \and
...
\input{sections/1-introduction.tex} % 引入第一章：引言

\input{sections/2-related_work.tex} % 引入第二章：相关工作

\input{sections/3-method.tex} % 引入第三章：方法

\input{sections/4-user_study.tex} % 引入第四章：用户研究
